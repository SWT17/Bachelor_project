...
*/
     ...
     * \brief Constants to be passed as "mode" parameter in the Direction_pin_SetDriveMode() function.
     *  @{
     */
...
/* Interrupt constants */
#if defined(Direction_pin__INTSTAT)
/**
* \addtogroup group_constants
* @{
*/
    /** \addtogroup intrMode Interrupt constants
     * \brief Constants to be passed as "mode" parameter in Direction_pin_SetInterruptMode() function.
     *  @{
     */
        #define Direction_pin_INTR_NONE      (uint16)(0x0000u)
        #define Direction_pin_INTR_RISING    (uint16)(0x0001u)
        #define Direction_pin_INTR_FALLING   (uint16)(0x0002u)
        #define Direction_pin_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define Direction_pin_INTR_MASK      (0x01u) 
#endif /* (Direction_pin__INTSTAT) */
...
/* SIO registers */
#if defined(Direction_pin__SIO_CFG)
    #define Direction_pin_SIO_HYST_EN        (* (reg8 *) Direction_pin__SIO_HYST_EN)
    #define Direction_pin_SIO_REG_HIFREQ     (* (reg8 *) Direction_pin__SIO_REG_HIFREQ)
    #define Direction_pin_SIO_CFG            (* (reg8 *) Direction_pin__SIO_CFG)
    #define Direction_pin_SIO_DIFF           (* (reg8 *) Direction_pin__SIO_DIFF)
#endif /* (Direction_pin__SIO_CFG) */
...
/* Interrupt Registers */
	...
	#define Direction_pin_0_INTTYPE_REG 		(* (reg8 *) Direction_pin__0__INTTYPE)
#endif /* (Direction_pin__INTSTAT) */

#endif /* CY_PSOC5A... */

#endif /*  CY_PINS_Direction_pin_H */
