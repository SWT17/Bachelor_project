...
/* Speed_pin */
#define Speed_pin__0__INTTYPE CYREG_PICU1_INTTYPE7
#define Speed_pin__0__MASK 0x80u
#define Speed_pin__0__PC CYREG_PRT1_PC7
#define Speed_pin__0__PORT 1u
#define Speed_pin__0__SHIFT 7u
#define Speed_pin__AG CYREG_PRT1_AG
#define Speed_pin__AMUX CYREG_PRT1_AMUX
#define Speed_pin__BIE CYREG_PRT1_BIE
#define Speed_pin__BIT_MASK CYREG_PRT1_BIT_MASK
#define Speed_pin__BYP CYREG_PRT1_BYP
#define Speed_pin__CTL CYREG_PRT1_CTL
#define Speed_pin__DM0 CYREG_PRT1_DM0
#define Speed_pin__DM1 CYREG_PRT1_DM1
#define Speed_pin__DM2 CYREG_PRT1_DM2
#define Speed_pin__DR CYREG_PRT1_DR
#define Speed_pin__INP_DIS CYREG_PRT1_INP_DIS
#define Speed_pin__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU1_BASE
#define Speed_pin__LCD_COM_SEG CYREG_PRT1_LCD_COM_SEG
#define Speed_pin__LCD_EN CYREG_PRT1_LCD_EN
#define Speed_pin__MASK 0x80u
#define Speed_pin__PORT 1u
#define Speed_pin__PRT CYREG_PRT1_PRT
#define Speed_pin__PRTDSI__CAPS_SEL CYREG_PRT1_CAPS_SEL
#define Speed_pin__PRTDSI__DBL_SYNC_IN CYREG_PRT1_DBL_SYNC_IN
#define Speed_pin__PRTDSI__OE_SEL0 CYREG_PRT1_OE_SEL0
#define Speed_pin__PRTDSI__OE_SEL1 CYREG_PRT1_OE_SEL1
#define Speed_pin__PRTDSI__OUT_SEL0 CYREG_PRT1_OUT_SEL0
#define Speed_pin__PRTDSI__OUT_SEL1 CYREG_PRT1_OUT_SEL1
#define Speed_pin__PRTDSI__SYNC_OUT CYREG_PRT1_SYNC_OUT
#define Speed_pin__PS CYREG_PRT1_PS
#define Speed_pin__SHIFT 7u
#define Speed_pin__SLW CYREG_PRT1_SLW
...
/* Enable_pin */
#define Enable_pin__0__INTTYPE CYREG_PICU0_INTTYPE2
#define Enable_pin__0__MASK 0x04u
#define Enable_pin__0__PC CYREG_PRT0_PC2
#define Enable_pin__0__PORT 0u
#define Enable_pin__0__SHIFT 2u
#define Enable_pin__AG CYREG_PRT0_AG
#define Enable_pin__AMUX CYREG_PRT0_AMUX
#define Enable_pin__BIE CYREG_PRT0_BIE
#define Enable_pin__BIT_MASK CYREG_PRT0_BIT_MASK
#define Enable_pin__BYP CYREG_PRT0_BYP
#define Enable_pin__CTL CYREG_PRT0_CTL
#define Enable_pin__DM0 CYREG_PRT0_DM0
#define Enable_pin__DM1 CYREG_PRT0_DM1
#define Enable_pin__DM2 CYREG_PRT0_DM2
#define Enable_pin__DR CYREG_PRT0_DR
#define Enable_pin__INP_DIS CYREG_PRT0_INP_DIS
#define Enable_pin__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU0_BASE
#define Enable_pin__LCD_COM_SEG CYREG_PRT0_LCD_COM_SEG
#define Enable_pin__LCD_EN CYREG_PRT0_LCD_EN
#define Enable_pin__MASK 0x04u
#define Enable_pin__PORT 0u
#define Enable_pin__PRT CYREG_PRT0_PRT
#define Enable_pin__PRTDSI__CAPS_SEL CYREG_PRT0_CAPS_SEL
#define Enable_pin__PRTDSI__DBL_SYNC_IN CYREG_PRT0_DBL_SYNC_IN
#define Enable_pin__PRTDSI__OE_SEL0 CYREG_PRT0_OE_SEL0
#define Enable_pin__PRTDSI__OE_SEL1 CYREG_PRT0_OE_SEL1
#define Enable_pin__PRTDSI__OUT_SEL0 CYREG_PRT0_OUT_SEL0
#define Enable_pin__PRTDSI__OUT_SEL1 CYREG_PRT0_OUT_SEL1
#define Enable_pin__PRTDSI__SYNC_OUT CYREG_PRT0_SYNC_OUT
#define Enable_pin__PS CYREG_PRT0_PS
#define Enable_pin__SHIFT 2u
#define Enable_pin__SLW CYREG_PRT0_SLW
...
/* Direction_pin */
#define Direction_pin__0__INTTYPE CYREG_PICU1_INTTYPE6
#define Direction_pin__0__MASK 0x40u
#define Direction_pin__0__PC CYREG_PRT1_PC6
#define Direction_pin__0__PORT 1u
#define Direction_pin__0__SHIFT 6u
#define Direction_pin__AG CYREG_PRT1_AG
#define Direction_pin__AMUX CYREG_PRT1_AMUX
#define Direction_pin__BIE CYREG_PRT1_BIE
#define Direction_pin__BIT_MASK CYREG_PRT1_BIT_MASK
#define Direction_pin__BYP CYREG_PRT1_BYP
#define Direction_pin__CTL CYREG_PRT1_CTL
#define Direction_pin__DM0 CYREG_PRT1_DM0
#define Direction_pin__DM1 CYREG_PRT1_DM1
#define Direction_pin__DM2 CYREG_PRT1_DM2
#define Direction_pin__DR CYREG_PRT1_DR
#define Direction_pin__INP_DIS CYREG_PRT1_INP_DIS
#define Direction_pin__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU1_BASE
#define Direction_pin__LCD_COM_SEG CYREG_PRT1_LCD_COM_SEG
#define Direction_pin__LCD_EN CYREG_PRT1_LCD_EN
#define Direction_pin__MASK 0x40u
#define Direction_pin__PORT 1u
#define Direction_pin__PRT CYREG_PRT1_PRT
#define Direction_pin__PRTDSI__CAPS_SEL CYREG_PRT1_CAPS_SEL
#define Direction_pin__PRTDSI__DBL_SYNC_IN CYREG_PRT1_DBL_SYNC_IN
#define Direction_pin__PRTDSI__OE_SEL0 CYREG_PRT1_OE_SEL0
#define Direction_pin__PRTDSI__OE_SEL1 CYREG_PRT1_OE_SEL1
#define Direction_pin__PRTDSI__OUT_SEL0 CYREG_PRT1_OUT_SEL0
#define Direction_pin__PRTDSI__OUT_SEL1 CYREG_PRT1_OUT_SEL1
#define Direction_pin__PRTDSI__SYNC_OUT CYREG_PRT1_SYNC_OUT
#define Direction_pin__PS CYREG_PRT1_PS
#define Direction_pin__SHIFT 6u
#define Direction_pin__SLW CYREG_PRT1_SLW
...
/* VDAC8_Enabling */
#define VDAC8_Enabling_viDAC8__CR0 CYREG_DAC0_CR0
#define VDAC8_Enabling_viDAC8__CR1 CYREG_DAC0_CR1
#define VDAC8_Enabling_viDAC8__D CYREG_DAC0_D
#define VDAC8_Enabling_viDAC8__PM_ACT_CFG CYREG_PM_ACT_CFG8
#define VDAC8_Enabling_viDAC8__PM_ACT_MSK 0x01u
#define VDAC8_Enabling_viDAC8__PM_STBY_CFG CYREG_PM_STBY_CFG8
#define VDAC8_Enabling_viDAC8__PM_STBY_MSK 0x01u
#define VDAC8_Enabling_viDAC8__STROBE CYREG_DAC0_STROBE
#define VDAC8_Enabling_viDAC8__SW0 CYREG_DAC0_SW0
#define VDAC8_Enabling_viDAC8__SW2 CYREG_DAC0_SW2
#define VDAC8_Enabling_viDAC8__SW3 CYREG_DAC0_SW3
#define VDAC8_Enabling_viDAC8__SW4 CYREG_DAC0_SW4
#define VDAC8_Enabling_viDAC8__TR CYREG_DAC0_TR
#define VDAC8_Enabling_viDAC8__TRIM__M1 CYREG_FLSHID_CUST_TABLES_DAC0_M1
#define VDAC8_Enabling_viDAC8__TRIM__M2 CYREG_FLSHID_CUST_TABLES_DAC0_M2
#define VDAC8_Enabling_viDAC8__TRIM__M3 CYREG_FLSHID_CUST_TABLES_DAC0_M3
#define VDAC8_Enabling_viDAC8__TRIM__M4 CYREG_FLSHID_CUST_TABLES_DAC0_M4
#define VDAC8_Enabling_viDAC8__TRIM__M5 CYREG_FLSHID_CUST_TABLES_DAC0_M5
#define VDAC8_Enabling_viDAC8__TRIM__M6 CYREG_FLSHID_CUST_TABLES_DAC0_M6
#define VDAC8_Enabling_viDAC8__TRIM__M7 CYREG_FLSHID_CUST_TABLES_DAC0_M7
#define VDAC8_Enabling_viDAC8__TRIM__M8 CYREG_FLSHID_CUST_TABLES_DAC0_M8
#define VDAC8_Enabling_viDAC8__TST CYREG_DAC0_TST

/* VDAC8_Direction */
#define VDAC8_Direction_viDAC8__CR0 CYREG_DAC1_CR0
#define VDAC8_Direction_viDAC8__CR1 CYREG_DAC1_CR1
#define VDAC8_Direction_viDAC8__D CYREG_DAC1_D
#define VDAC8_Direction_viDAC8__PM_ACT_CFG CYREG_PM_ACT_CFG8
#define VDAC8_Direction_viDAC8__PM_ACT_MSK 0x02u
#define VDAC8_Direction_viDAC8__PM_STBY_CFG CYREG_PM_STBY_CFG8
#define VDAC8_Direction_viDAC8__PM_STBY_MSK 0x02u
#define VDAC8_Direction_viDAC8__STROBE CYREG_DAC1_STROBE
#define VDAC8_Direction_viDAC8__SW0 CYREG_DAC1_SW0
#define VDAC8_Direction_viDAC8__SW2 CYREG_DAC1_SW2
#define VDAC8_Direction_viDAC8__SW3 CYREG_DAC1_SW3
#define VDAC8_Direction_viDAC8__SW4 CYREG_DAC1_SW4
#define VDAC8_Direction_viDAC8__TR CYREG_DAC1_TR
#define VDAC8_Direction_viDAC8__TRIM__M1 CYREG_FLSHID_CUST_TABLES_DAC1_M1
#define VDAC8_Direction_viDAC8__TRIM__M2 CYREG_FLSHID_CUST_TABLES_DAC1_M2
#define VDAC8_Direction_viDAC8__TRIM__M3 CYREG_FLSHID_CUST_TABLES_DAC1_M3
#define VDAC8_Direction_viDAC8__TRIM__M4 CYREG_FLSHID_CUST_TABLES_DAC1_M4
#define VDAC8_Direction_viDAC8__TRIM__M5 CYREG_FLSHID_CUST_TABLES_DAC1_M5
#define VDAC8_Direction_viDAC8__TRIM__M6 CYREG_FLSHID_CUST_TABLES_DAC1_M6
#define VDAC8_Direction_viDAC8__TRIM__M7 CYREG_FLSHID_CUST_TABLES_DAC1_M7
#define VDAC8_Direction_viDAC8__TRIM__M8 CYREG_FLSHID_CUST_TABLES_DAC1_M8
#define VDAC8_Direction_viDAC8__TST CYREG_DAC1_TST

/* PGA_SpeedControl */
#define PGA_SpeedControl_SC__BST CYREG_SC1_BST
#define PGA_SpeedControl_SC__CLK CYREG_SC1_CLK
#define PGA_SpeedControl_SC__CMPINV CYREG_SC_CMPINV
#define PGA_SpeedControl_SC__CMPINV_MASK 0x02u
#define PGA_SpeedControl_SC__CPTR CYREG_SC_CPTR
#define PGA_SpeedControl_SC__CPTR_MASK 0x02u
#define PGA_SpeedControl_SC__CR0 CYREG_SC1_CR0
#define PGA_SpeedControl_SC__CR1 CYREG_SC1_CR1
#define PGA_SpeedControl_SC__CR2 CYREG_SC1_CR2
#define PGA_SpeedControl_SC__MSK CYREG_SC_MSK
#define PGA_SpeedControl_SC__MSK_MASK 0x02u
#define PGA_SpeedControl_SC__PM_ACT_CFG CYREG_PM_ACT_CFG9
#define PGA_SpeedControl_SC__PM_ACT_MSK 0x02u
#define PGA_SpeedControl_SC__PM_STBY_CFG CYREG_PM_STBY_CFG9
#define PGA_SpeedControl_SC__PM_STBY_MSK 0x02u
#define PGA_SpeedControl_SC__SR CYREG_SC_SR
#define PGA_SpeedControl_SC__SR_MASK 0x02u
#define PGA_SpeedControl_SC__SW0 CYREG_SC1_SW0
#define PGA_SpeedControl_SC__SW10 CYREG_SC1_SW10
#define PGA_SpeedControl_SC__SW2 CYREG_SC1_SW2
#define PGA_SpeedControl_SC__SW3 CYREG_SC1_SW3
#define PGA_SpeedControl_SC__SW4 CYREG_SC1_SW4
#define PGA_SpeedControl_SC__SW6 CYREG_SC1_SW6
#define PGA_SpeedControl_SC__SW7 CYREG_SC1_SW7
#define PGA_SpeedControl_SC__SW8 CYREG_SC1_SW8
#define PGA_SpeedControl_SC__WRK1 CYREG_SC_WRK1
#define PGA_SpeedControl_SC__WRK1_MASK 0x02u

/* Clock_TempSampling */
#define Clock_TempSampling__CFG0 CYREG_CLKDIST_DCFG2_CFG0
#define Clock_TempSampling__CFG1 CYREG_CLKDIST_DCFG2_CFG1
#define Clock_TempSampling__CFG2 CYREG_CLKDIST_DCFG2_CFG2
#define Clock_TempSampling__CFG2_SRC_SEL_MASK 0x07u
#define Clock_TempSampling__INDEX 0x02u
#define Clock_TempSampling__PM_ACT_CFG CYREG_PM_ACT_CFG2
#define Clock_TempSampling__PM_ACT_MSK 0x04u
#define Clock_TempSampling__PM_STBY_CFG CYREG_PM_STBY_CFG2
#define Clock_TempSampling__PM_STBY_MSK 0x04u

/* VDAC8_SpeedControl */
#define VDAC8_SpeedControl_viDAC8__CR0 CYREG_DAC3_CR0
#define VDAC8_SpeedControl_viDAC8__CR1 CYREG_DAC3_CR1
#define VDAC8_SpeedControl_viDAC8__D CYREG_DAC3_D
#define VDAC8_SpeedControl_viDAC8__PM_ACT_CFG CYREG_PM_ACT_CFG8
#define VDAC8_SpeedControl_viDAC8__PM_ACT_MSK 0x08u
#define VDAC8_SpeedControl_viDAC8__PM_STBY_CFG CYREG_PM_STBY_CFG8
#define VDAC8_SpeedControl_viDAC8__PM_STBY_MSK 0x08u
#define VDAC8_SpeedControl_viDAC8__STROBE CYREG_DAC3_STROBE
#define VDAC8_SpeedControl_viDAC8__SW0 CYREG_DAC3_SW0
#define VDAC8_SpeedControl_viDAC8__SW2 CYREG_DAC3_SW2
#define VDAC8_SpeedControl_viDAC8__SW3 CYREG_DAC3_SW3
#define VDAC8_SpeedControl_viDAC8__SW4 CYREG_DAC3_SW4
#define VDAC8_SpeedControl_viDAC8__TR CYREG_DAC3_TR
#define VDAC8_SpeedControl_viDAC8__TRIM__M1 CYREG_FLSHID_CUST_TABLES_DAC3_M1
#define VDAC8_SpeedControl_viDAC8__TRIM__M2 CYREG_FLSHID_CUST_TABLES_DAC3_M2
#define VDAC8_SpeedControl_viDAC8__TRIM__M3 CYREG_FLSHID_CUST_TABLES_DAC3_M3
#define VDAC8_SpeedControl_viDAC8__TRIM__M4 CYREG_FLSHID_CUST_TABLES_DAC3_M4
#define VDAC8_SpeedControl_viDAC8__TRIM__M5 CYREG_FLSHID_CUST_TABLES_DAC3_M5
#define VDAC8_SpeedControl_viDAC8__TRIM__M6 CYREG_FLSHID_CUST_TABLES_DAC3_M6
#define VDAC8_SpeedControl_viDAC8__TRIM__M7 CYREG_FLSHID_CUST_TABLES_DAC3_M7
#define VDAC8_SpeedControl_viDAC8__TRIM__M8 CYREG_FLSHID_CUST_TABLES_DAC3_M8
#define VDAC8_SpeedControl_viDAC8__TST CYREG_DAC3_TST
