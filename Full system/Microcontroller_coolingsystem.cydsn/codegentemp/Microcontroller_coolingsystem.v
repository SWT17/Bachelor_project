...
// PGA_v2_0(Gain=1, Power=1, VddaValue=5, Vref_Input=0, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=PGA_v2_0, CY_CONFIG_TITLE=PGA_SpeedControl, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PGA_SpeedControl, CY_INSTANCE_SHORT_NAME=PGA_SpeedControl, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=PGA_SpeedControl, )
module PGA_v2_0_1 (
    Vin,
    Vout,
    Vref);
...
// VDAC8_v1_90(Data_Source=0, Initial_Value=0, Strobe_Mode=0, VDAC_Range=4, VDAC_Speed=0, Voltage=0, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=VDAC8_v1_90, CY_CONFIG_TITLE=VDAC8_SpeedControl, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=VDAC8_SpeedControl, CY_INSTANCE_SHORT_NAME=VDAC8_SpeedControl, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=90, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=VDAC8_SpeedControl, )
...
// Counter_v3_0(CaptureMode=0, CaptureModeSoftware=0, ClockMode=0, CompareMode=1, CompareModeSoftware=0, CompareStatusEdgeSense=true, CompareValue=1, CONTROL3=1, ControlRegRemoved=0, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, EnableMode=0, FF16=true, FF8=false, FixedFunction=true, FixedFunctionUsed=1, InitCounterValue=0, InterruptOnCapture=false, InterruptOnCompare=false, InterruptOnOverUnderFlow=false, InterruptOnTC=true, Period=1000, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, ReloadOnCapture=false, ReloadOnCompare=false, ReloadOnOverUnder=true, ReloadOnReset=true, Resolution=16, RunMode=0, UDB16=false, UDB24=false, UDB32=false, UDB8=false, UDBControlReg=false, UseInterrupt=true, VerilogSectionReplacementString=sC16, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=Counter_v3_0, CY_CONFIG_TITLE=Temp_sample_counter, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Temp_sample_counter, CY_INSTANCE_SHORT_NAME=Temp_sample_counter, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=Temp_sample_counter, )
...
// VDAC8_v1_90(Data_Source=0, Initial_Value=0, Strobe_Mode=0, VDAC_Range=4, VDAC_Speed=0, Voltage=0, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=VDAC8_v1_90, CY_CONFIG_TITLE=VDAC8_Enabling, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=VDAC8_Enabling, CY_INSTANCE_SHORT_NAME=VDAC8_Enabling, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=90, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=VDAC8_Enabling, )
...
// VDAC8_v1_90(Data_Source=0, Initial_Value=0, Strobe_Mode=0, VDAC_Range=4, VDAC_Speed=0, Voltage=0, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=VDAC8_v1_90, CY_CONFIG_TITLE=VDAC8_Direction, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=VDAC8_Direction, CY_INSTANCE_SHORT_NAME=VDAC8_Direction, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=90, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=VDAC8_Direction, )
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("2c636b17-7d83-44d8-9252-73a8e55283e5"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("f9581703-704a-43ce-8ea2-ed0e5c4d2e33"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("d3d35a21-34be-4da9-9659-f556242c8747"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
    ...
    PGA_v2_0_1 PGA_SpeedControl (
        .Vin(Net_114),
        .Vout(Net_117),
        .Vref(Net_115));

	wire [0:0] tmpOE__Speed_pin_net;
	wire [0:0] tmpFB_0__Speed_pin_net;
	wire [0:0] tmpIO_0__Speed_pin_net;
	wire [0:0] tmpINTERRUPT_0__Speed_pin_net;
	electrical [0:0] tmpSIOVREF__Speed_pin_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .input_buffer_sel(2'b00))
		Speed_pin
		 (.oe(tmpOE__Speed_pin_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Speed_pin_net[0:0]}),
		  .analog({Net_117}),
		  .io({tmpIO_0__Speed_pin_net[0:0]}),
		  .siovref(tmpSIOVREF__Speed_pin_net),
		  .interrupt({tmpINTERRUPT_0__Speed_pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Speed_pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    VDAC8_v1_90_3 VDAC8_SpeedControl (
        .data(8'b00000000),
        .strobe(1'b0),
        .vOut(Net_114));
    defparam VDAC8_SpeedControl.Data_Source = 0;
    defparam VDAC8_SpeedControl.Initial_Value = 0;
    defparam VDAC8_SpeedControl.Strobe_Mode = 0;

	wire [0:0] tmpOE__Enable_pin_net;
	wire [0:0] tmpFB_0__Enable_pin_net;
	wire [0:0] tmpIO_0__Enable_pin_net;
	wire [0:0] tmpINTERRUPT_0__Enable_pin_net;
	electrical [0:0] tmpSIOVREF__Enable_pin_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		Enable_pin
		 (.oe(tmpOE__Enable_pin_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Enable_pin_net[0:0]}),
		  .analog({Net_215}),
		  .io({tmpIO_0__Enable_pin_net[0:0]}),
		  .siovref(tmpSIOVREF__Enable_pin_net),
		  .interrupt({tmpINTERRUPT_0__Enable_pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Enable_pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("2ba02de0-5628-43fc-8890-00defb662015"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("7c16d399-b141-42f7-ae70-5fa4d2ecadc1"),
		  .source_clock_id(""),
		  .divisor(0),
    ...
    Counter_v3_0_4 Temp_sample_counter (
        .capture(1'b0),
        .clock(Net_134),
        .comp(Net_220),
        .count(1'b0),
        ...
        .up_ndown(1'b1),
        .upCnt(1'b0));
    defparam Temp_sample_counter.CaptureMode = 0;
    defparam Temp_sample_counter.ClockMode = 0;
    defparam Temp_sample_counter.CompareMode = 1;
    defparam Temp_sample_counter.CompareStatusEdgeSense = 1;
    defparam Temp_sample_counter.EnableMode = 0;
    defparam Temp_sample_counter.ReloadOnCapture = 0;
    defparam Temp_sample_counter.ReloadOnCompare = 0;
    defparam Temp_sample_counter.ReloadOnOverUnder = 1;
    defparam Temp_sample_counter.ReloadOnReset = 1;
    defparam Temp_sample_counter.Resolution = 16;
    defparam Temp_sample_counter.RunMode = 0;
    defparam Temp_sample_counter.UseInterrupt = 1;
	...
	wire [0:0] tmpOE__Switch_output_net;
	wire [0:0] tmpFB_0__Switch_output_net;
	wire [0:0] tmpIO_0__Switch_output_net;
	wire [0:0] tmpINTERRUPT_0__Switch_output_net;
	electrical [0:0] tmpSIOVREF__Switch_output_net;

	cy_psoc3_pins_v1_10
		#(.id("39f5748d-4be2-4f7e-b606-1eed3fb78ade"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Switch_output
		 (.oe(tmpOE__Switch_output_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Switch_output_net[0:0]}),
		  .io({tmpIO_0__Switch_output_net[0:0]}),
		  .siovref(tmpSIOVREF__Switch_output_net),
		  .interrupt({tmpINTERRUPT_0__Switch_output_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Switch_output_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Switch_input_net;
	wire [0:0] tmpFB_0__Switch_input_net;
	wire [0:0] tmpIO_0__Switch_input_net;
	electrical [0:0] tmpSIOVREF__Switch_input_net;

	cy_psoc3_pins_v1_10
		#(.id("36c98c7f-8e58-4843-8858-0c45002263b4"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Switch_input
		 (.oe(tmpOE__Switch_input_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Switch_input_net[0:0]}),
		  .io({tmpIO_0__Switch_input_net[0:0]}),
		  .siovref(tmpSIOVREF__Switch_input_net),
		  .interrupt({Net_167}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Switch_input_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    VDAC8_v1_90_5 VDAC8_Enabling (
        ...
        .strobe(1'b0),
        .vOut(Net_215));
    defparam VDAC8_Enabling.Data_Source = 0;
    defparam VDAC8_Enabling.Initial_Value = 0;
    defparam VDAC8_Enabling.Strobe_Mode = 0;

    VDAC8_v1_90_6 VDAC8_Direction (
        .data(8'b00000000),
        .strobe(1'b0),
        .vOut(Net_232));
    defparam VDAC8_Direction.Data_Source = 0;
    defparam VDAC8_Direction.Initial_Value = 0;
    defparam VDAC8_Direction.Strobe_Mode = 0;

	wire [0:0] tmpOE__Direction_pin_net;
	wire [0:0] tmpFB_0__Direction_pin_net;
	wire [0:0] tmpIO_0__Direction_pin_net;
	wire [0:0] tmpINTERRUPT_0__Direction_pin_net;
	electrical [0:0] tmpSIOVREF__Direction_pin_net;

	cy_psoc3_pins_v1_10
		#(.id("61edf9cb-0ab4-4150-9112-533f4f45c763"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Direction_pin
		 (.oe(tmpOE__Direction_pin_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Direction_pin_net[0:0]}),
		  .analog({Net_232}),
		  .io({tmpIO_0__Direction_pin_net[0:0]}),
		  .siovref(tmpSIOVREF__Direction_pin_net),
		  .interrupt({tmpINTERRUPT_0__Direction_pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Direction_pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
